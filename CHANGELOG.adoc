...
* Add self provisioned ES test to main e2e test goal (https://github.com/jaegertracing/jaeger-operator/pull/341[#341])
* Update allInOneWithIngressTest to work on OpenShift (https://github.com/jaegertracing/jaeger-operator/pull/340[#340])
...
* Add e2e test for self provisioned Elasticsearch (https://github.com/jaegertracing/jaeger-operator/pull/336[#336])
...
* Restore es-index-cleaner test (https://github.com/jaegertracing/jaeger-operator/pull/328[#328])
* Update tests to work on OpenShift (https://github.com/jaegertracing/jaeger-operator/pull/323[#323])
* Disable spark dependencies for self provisioned es (https://github.com/jaegertracing/jaeger-operator/pull/319[#319])
* Revert metrics in status object (https://github.com/jaegertracing/jaeger-operator/pull/318[#318])
* Fix reporter type flag (https://github.com/jaegertracing/jaeger-operator/pull/317[#317])
...
* Remove unused error (https://github.com/jaegertracing/jaeger-operator/pull/312[#312])
...
* Increase timeout in e2e tests (https://github.com/jaegertracing/jaeger-operator/pull/291[#291])
...
* Use current namespace for storage (https://github.com/jaegertracing/jaeger-operator/pull/278[#278])
* Watch all namespaces in makefile (https://github.com/jaegertracing/jaeger-operator/pull/287[#287])
* Fix clean storage goal (https://github.com/jaegertracing/jaeger-operator/pull/281[#281])
...
* Fix ES and Cassandra tests which were failing on OpenShift (https://github.com/jaegertracing/jaeger-operator/pull/275[#275])
...
* Changed from 'size' to 'replicas' (https://github.com/jaegertracing/jaeger-operator/pull/271[#271])
* Split the E2E tests into smoke/cassandra/es (https://github.com/jaegertracing/jaeger-operator/pull/269[#269])
* Moved from v1alpha1 to v1 (https://github.com/jaegertracing/jaeger-operator/pull/265[#265])
* Added metrics to JaegerStatus object (https://github.com/jaegertracing/jaeger-operator/pull/254[#254])
...
* Fixed the version bump during the release in deploy artifacts (https://github.com/jaegertracing/jaeger-operator/pull/247[#247])
