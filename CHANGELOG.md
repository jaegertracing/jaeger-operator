...
* Update actions/checkout requirement to v2.3.4 ([#1381](https://github.com/jaegertracing/jaeger-operator/pull/1381), [@dependabot[bot]](https://github.com/apps/dependabot))
* Removed the remaining otel items from the mergify configuration ([#1384](https://github.com/jaegertracing/jaeger-operator/pull/1384), [@jpkrohling](https://github.com/jpkrohling))
* Bump github/issue-labeler from v2.0 to v2.2 ([#1382](https://github.com/jaegertracing/jaeger-operator/pull/1382), [@dependabot[bot]](https://github.com/apps/dependabot))
* Bump actions/setup-go from v1 to v2.1.3 ([#1383](https://github.com/jaegertracing/jaeger-operator/pull/1383), [@dependabot[bot]](https://github.com/apps/dependabot))
* Bump github.com/gogo/protobuf to v1.3.2 ([#1377](https://github.com/jaegertracing/jaeger-operator/pull/1377), [@jpkrohling](https://github.com/jpkrohling))
...
* Add github actions to dependabot, auto merge on green for dependabot PRs ([#1376](https://github.com/jaegertracing/jaeger-operator/pull/1376), [@jpkrohling](https://github.com/jpkrohling))
...
* Skipping Kafka related tests in examples2 when Kafka is not available ([#1362](https://github.com/jaegertracing/jaeger-operator/pull/1362), [@madeelrh](https://github.com/madeelrh))
* Fix release action, set operator sdk ([#1363](https://github.com/jaegertracing/jaeger-operator/pull/1363), [@rubenvp8510](https://github.com/rubenvp8510))
...
* fix e2e tests es index cleaner namespace issue ([#1340](https://github.com/jaegertracing/jaeger-operator/pull/1340), [@jkandasa](https://github.com/jkandasa))
...
* e2e index cleaner tests improvements  ([#1331](https://github.com/jaegertracing/jaeger-operator/pull/1331), [@jkandasa](https://github.com/jkandasa))
...
* Fix unstable mod tidy ([#1327](https://github.com/jaegertracing/jaeger-operator/pull/1327), [@lujiajing1126](https://github.com/lujiajing1126))
* Enable running tests without an external ES instance ([#1316](https://github.com/jaegertracing/jaeger-operator/pull/1316), [@kevinearls](https://github.com/kevinearls))
...
* Allow overriding vertx image when testing examples ([#1320](https://github.com/jaegertracing/jaeger-operator/pull/1320), [@kevinearls](https://github.com/kevinearls))
