...
* When using OLM we still need to create and delete the cluster ([#630](https://github.com/jaegertracing/jaeger-operator/pull/630))
* Replaced git.apache.org/thrift with github's location ([#633](https://github.com/jaegertracing/jaeger-operator/pull/633))
* Add resource limits for spark dependencies cronjob ([#620](https://github.com/jaegertracing/jaeger-operator/pull/620))
* Update tests to permit running with operators installed via OperatorHub ([#626](https://github.com/jaegertracing/jaeger-operator/pull/626))
* Add Jaeger version to Elasticsearch job images ([#628](https://github.com/jaegertracing/jaeger-operator/pull/628))
* Divide examples to speed up ci ([#625](https://github.com/jaegertracing/jaeger-operator/pull/625))
* Add badger to supported list of storage types ([#616](https://github.com/jaegertracing/jaeger-operator/pull/616))
* Added release workflow ([#619](https://github.com/jaegertracing/jaeger-operator/pull/619))
* Added github workflow ([#617](https://github.com/jaegertracing/jaeger-operator/pull/617))
* Changed how we skip the 'docker push' for CIs ([#615](https://github.com/jaegertracing/jaeger-operator/pull/615))
* Move self provisioned ES example to Openshift subfolder ([#612](https://github.com/jaegertracing/jaeger-operator/pull/612))
...
* Removed github workflow ([#603](https://github.com/jaegertracing/jaeger-operator/pull/603))
* Added basic workflow ([#600](https://github.com/jaegertracing/jaeger-operator/pull/600))
* Add format verification for tests, and apply it ([#596](https://github.com/jaegertracing/jaeger-operator/pull/596))
* Add test for elasticsearch index prefixes ([#588](https://github.com/jaegertracing/jaeger-operator/pull/588))
* Change OLM catalog package channel to stable ([#594](https://github.com/jaegertracing/jaeger-operator/pull/594))
...
* Initial tests for the examples ([#582](https://github.com/jaegertracing/jaeger-operator/pull/582))
* Retry install ([#580](https://github.com/jaegertracing/jaeger-operator/pull/580))
* Agent service ports with correct protocol ([#579](https://github.com/jaegertracing/jaeger-operator/pull/579))
* Minor fixes to get examples working ([#578](https://github.com/jaegertracing/jaeger-operator/pull/578))
...
* Fixed the release script to work with M.m.p.o ([#566](https://github.com/jaegertracing/jaeger-operator/pull/566))
* Further simplify smoke test ([#563](https://github.com/jaegertracing/jaeger-operator/pull/563))
* Simplify usage of smoke test by having it do port forwarding ([#561](https://github.com/jaegertracing/jaeger-operator/pull/561))
...
* Add test to validate elasticsearch-operator image ([#550](https://github.com/jaegertracing/jaeger-operator/pull/550))
* Fixed pushing of images to Docker Hub ([#556](https://github.com/jaegertracing/jaeger-operator/pull/556))
* Added push of container images to quay ([#553](https://github.com/jaegertracing/jaeger-operator/pull/553))
...
* Use random ports when port forwarding ([#545](https://github.com/jaegertracing/jaeger-operator/pull/545))
* Add make cleanup targets for es-operator and kafka ([#548](https://github.com/jaegertracing/jaeger-operator/pull/548))
* Run ES self provisioned e2e test on travis using OCP 3.9 ([#542](https://github.com/jaegertracing/jaeger-operator/pull/542))
* Update README to reference operator documentation on jaegertracing.io ([#543](https://github.com/jaegertracing/jaeger-operator/pull/543))
...
* Change jaeger.version file to use major.minor.patch version ([#534](https://github.com/jaegertracing/jaeger-operator/pull/534))
* Use ES single redundancy by default ([#531](https://github.com/jaegertracing/jaeger-operator/pull/531))
* Added documentation for es cleaner job ([#491](https://github.com/jaegertracing/jaeger-operator/pull/491))
...
* Fix the go.mod ([#527](https://github.com/jaegertracing/jaeger-operator/pull/527))
* Prepared the code base for openapi code generation ([#517](https://github.com/jaegertracing/jaeger-operator/pull/517))
...
* Reverted change to the operator's image ([#524](https://github.com/jaegertracing/jaeger-operator/pull/524))
* Added support for OpenShift-specific OAuth Proxy options ([#508](https://github.com/jaegertracing/jaeger-operator/pull/508))
* Restore this test, it works with version 4.1.2 of the elasticsearch operator ([#512](https://github.com/jaegertracing/jaeger-operator/pull/512))
* Update tests to undeploy Jaeger instance at end ([#516](https://github.com/jaegertracing/jaeger-operator/pull/516))
...
* Fix the daemonset test to work after pr346 changes ([#511](https://github.com/jaegertracing/jaeger-operator/pull/511))
* Streamline tests by simplifying calls to CreatePortForward ([#509](https://github.com/jaegertracing/jaeger-operator/pull/509))
