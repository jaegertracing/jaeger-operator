...
[source,bash]
----
kubectl create -f https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/crd/io_v1alpha1_jaeger_crd.yaml
...
oc create -f https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/crd/io_v1alpha1_jaeger_crd.yaml
...
kubectl delete -f https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/crd/io_v1alpha1_jaeger_crd.yaml
----
