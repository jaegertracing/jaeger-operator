...
func TestKafkaInventory(t *testing.T) {
	toCreate := v1beta1.Kafka{
		ObjectMeta: metav1.ObjectMeta{
			Name: "to-create",
		},
	}
	toUpdate := v1beta1.Kafka{
		ObjectMeta: metav1.ObjectMeta{
			Name: "to-update",
		},
	...
	toDelete := v1beta1.Kafka{
		ObjectMeta: metav1.ObjectMeta{
			Name: "to-delete",
		},
	}

	existing := []v1beta1.Kafka{toUpdate, toDelete}
	desired := []v1beta1.Kafka{updated, toCreate}
...
func TestKafkaInventoryWithSameNameInstances(t *testing.T) {
	...
	inv := ForKafkas([]v1beta1.Kafka{}, create)
