...
func schema_pkg_apis_jaegertracing_v1_ElasticsearchSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"storage": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/storage/elasticsearch/v1.ElasticsearchStorageSpec"),
						},
					},
					"redundancyPolicy": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"./pkg/storage/elasticsearch/v1.ElasticsearchStorageSpec", "k8s.io/api/core/v1.ResourceRequirements"},
	}
}
