...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JaegerQueryOauthProxySpec.
func (in *JaegerQueryOauthProxySpec) DeepCopy() *JaegerQueryOauthProxySpec {
	if in == nil {
		return nil
	}
