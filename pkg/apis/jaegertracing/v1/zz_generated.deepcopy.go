...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GRPCStoragePluginSpec) DeepCopyInto(out *GRPCStoragePluginSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GRPCStoragePluginSpec.
func (in *GRPCStoragePluginSpec) DeepCopy() *GRPCStoragePluginSpec {
	if in == nil {
		return nil
	}
	out := new(GRPCStoragePluginSpec)
	in.DeepCopyInto(out)
	return out
}
