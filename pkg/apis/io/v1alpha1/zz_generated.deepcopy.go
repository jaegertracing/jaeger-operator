...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JaegerRouteSpec) DeepCopyInto(out *JaegerRouteSpec) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JaegerRouteSpec.
func (in *JaegerRouteSpec) DeepCopy() *JaegerRouteSpec {
	if in == nil {
		return nil
	}
	out := new(JaegerRouteSpec)
	in.DeepCopyInto(out)
	return out
}
