...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JaegerSparkDependenciesSpec) DeepCopyInto(out *JaegerSparkDependenciesSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JaegerSparkDependenciesSpec.
func (in *JaegerSparkDependenciesSpec) DeepCopy() *JaegerSparkDependenciesSpec {
	if in == nil {
		return nil
	}
	out := new(JaegerSparkDependenciesSpec)
	in.DeepCopyInto(out)
	return out
}
